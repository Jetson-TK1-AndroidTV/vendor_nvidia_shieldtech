...
LOCAL_SRC_FILES := apps/BlakePairing/BlakePairing.apk
LOCAL_PREBUILT_JNI_LIBS := lib/libfirmwareupdate.so lib/libhidraw.so
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := apps/ConsoleUI/ConsoleUI.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_APPS)
...
include $(CLEAR_VARS)
LOCAL_MODULE := PrebuiltShieldRemoteService
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := apps/PrebuiltShieldRemoteService/PrebuiltShieldRemoteService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_PRIVILEGED_MODULE := true
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
...
include $(CLEAR_VARS)
LOCAL_MODULE := ShieldBluetoothManager
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := apps/ShieldBluetoothManager/ShieldBluetoothManager.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_PRIVILEGED_MODULE := true
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := apps/NvShieldTech/NvShieldTech.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_PRIVILEGED_MODULE := true
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := apps/NvRpxService/NvRpxService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_PRIVILEGED_MODULE := true
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := lib/hdmi_cec.tegra.so
...
LOCAL_SRC_FILES := lib/audio.nvrc.tegra.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TARGET_ARCH := arm
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/system/vendor/lib/hw
...
LOCAL_SRC_FILES := lib/audio.nvwc.tegra.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TARGET_ARCH := arm
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/system/vendor/lib/hw
